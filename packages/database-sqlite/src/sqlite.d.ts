...
/*
  export class JsStorageDb implements DatabaseApi {
    public constructor(mode: "local" | "session");
...
*/
  ...
  export class Database {
    ...
    public constructor(filename: string, flags: string, vfs?: any);

    public filename: string;
    public pointer: number;
    public exec(input: string, opts?: ExecThisOptions): Database;
    public exec(input: string, opts?: ExecResultRowsOptions): any;

    public exec(opts: ExecThisOptions): Database;
    public exec(opts: ExecResultRowsOptions): any;

    // exec(opts: ExecOptions & {returnValue: "resultRows"}): any;
    public prepare(sql: string): PreparedStatement;

    public isOpen: () => boolean;
    public affirmOpen: () => Database;
    public close: () => void;
    public changes: (total?: boolean, sixtyFour?: boolean) => number;
    public dbFilename: () => string;
    public dbName: () => string;
    public dbVfsName: (dbName: any) => string;
    public createFunction: Function;

    public selectValue: Function;
    public selectValues: Function;
    public selectArray: Function;
    public selectObject: Function;
    public selectArrays: Function;
    public selectObjects: Function;

    public openStatementCount: Function;
    public transaction: Function;
    public savepoint: Function;
    public checkRc: Function;
  }
