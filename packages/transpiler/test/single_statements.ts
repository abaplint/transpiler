...
//    {abap: "PERFORM ('ASDF') IN PROGRAM ('ASDF') TABLES bar.",      js: `throw new Error("PerformTranspiler FormName not found");`,                       skip: false},
  ...
  withKeySimple: {"program_ndx": lv_program_ndx}});`,   skip: false},
    ...
    {abap: "GET REFERENCE OF blah INTO ref.", js: `abap.statements.getReference(blah, ref);`, skip: false},
    {abap: `GET REFERENCE OF <item> INTO lr_stack_top.`, js: `abap.statements.getReference(fs_item_, lr_stack_top);`, skip: false},
