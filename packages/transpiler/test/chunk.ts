...
describe("Chunk", () => {
  ...
  it("append lines", async () => {
    const chunk1 = new Chunk("START", new Position(1, 1));
    chunk1.appendString("\n");
    const chunk2 = new Chunk("END", new Position(2, 1));
  ...
  it("append on same line", async () => {
    const chunk1 = new Chunk("123", new Position(1, 1));
    const chunk2 = new Chunk("456", new Position(1, 4));
    chunk1.appendChunk(chunk2);
